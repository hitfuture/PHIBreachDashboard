...
statePop <- read.csv("https://www2.census.gov/programs-surveys/popest/datasets/2010-2014/state/asrh/scprc-est2014-18+pop-res.csv")
sfips <- read.csv("https://www2.census.gov/geo/docs/reference/state.txt",sep = "|")
